...
SWEP.PrintName = "Consular Saber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_knightconsular" --The file name of this swep
...
SWEP.MaxForce = 150 --The maximum amount of force in the meter
SWEP.RegenSpeed = 1.3 --The MULTIPLIER for the regen speed. Half speed = 0.5, Double speed = 2, etc.
SWEP.CanKnockback = true --Should this saber be able to push people back when they get hit?
SWEP.ForcePowerList = { "Force Leap", "Force Heal", "Group Heal", "Saber Throw", "Force Repulse", "Force Push", "Force Pull", "Meditate"} 
