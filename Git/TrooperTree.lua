local Troopers = {TEAM_REPUBLICTRP, TEAM_SITHTRP, TEAM_REPUBLICARMYSGT, TEAM_SITHARMYSGT, TEAM_REPUBLICARMYOFF, TEAM_SITH_ARMYOFF, TEAM_REPUBLICARMYGEN, TEAM_SITHARMYGEN}
